...
RSpec.describe NotesController, type: :controller do
  ...
  describe "Rollback" do
    it "destroys the old version amd create new version" do
      @note = Note.create(:title => "title", :body => "body")
      @version = Version.create(:title => "version title", :body => "version body", :note_id => @note.id)
      expect {
        get :rollback, to: {"note_id"=> @note.id, "version_id"=> @version.id}
